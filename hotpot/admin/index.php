...
<body id="home">
    ...
    <div class="container-fluid">
        ...
        <div class="card2" id="welcome">
            ...
            <h3 class="Plan">Welcome Admin</h3>
            <p class="textDesc"><strong>Your dedication and work has high importance!</strong><br>
                In order to keep our customers satisfied with using application Hot.Pot it would be stunning<br>
                when you would check all orders regularly and take good care for our customers.
                So help us to be their partner in healthier and more practical lifestyle.</p>

            <a href="./order.php"><button class="how-it-works">Orders</button></a>
        </div>
